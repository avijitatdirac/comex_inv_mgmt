...
class ComponentToPrint extends Component {
  ...
  getMainLocation = () => {
    ...
    this.props.locations.forEach(location => {
      ...
      if (
        location.isMain === 1 &&
        location.customerId === this.props.customerId
      ) {
        ...
        <Container textAlign="center">
          ...
          <Grid columns={2} celled>
            ...
            <Grid.Row>
              <Grid.Column>
                ...
                <Container textAlign="left">
                  <p>
                    #102, First Floor, May Fair Court, Nachiket Park, Dr. Pai
                    Marg,
                  </p>
            ...
            <Grid.Row columns={1}>
              <Grid.Column>
                <Container textAlign="center">
                  Please receive the goods in good condition and return the
                  challans duly signed
                </Container>
              </Grid.Column>
            </Grid.Row>
  ...
  assetListTable = () => (
    <Table basic celled>
      ...
      <Table.Footer>
        <Table.HeaderCell>
          Total Qty:{this.props.cartItems.length}
        </Table.HeaderCell>
        <Table.HeaderCell />
        <Table.HeaderCell />
        <Table.HeaderCell />
